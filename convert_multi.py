...
def CC2MT_ConvertWorld(BlocksModName, MTChunkPosX, MTChunkPosY, MTChunkPosZ, IsTest):
    ...
    MT_SpawnX = CC_SpawnX * -1 + CC_RealWorldSizeX
...
#CC2MT_ConvertBlocks('secondblocks') #blocks_modname
#CC2MT_ConvertWorld('secondblocks', 17, 0, 0) #using blocks_modname blocks



#CC2MT_MT_Final('multiworld') #worldname
